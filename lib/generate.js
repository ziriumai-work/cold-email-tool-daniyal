  ...
  return [
    { role: 'system', content: CUSTOM_WRITER_SYSTEM },
    {
      ...
      content:
        ...
        `Draft the cold outreach email following all instructions and rules. Do not include any sign-off, closing, or signature block at the end. Return strictly in the required format.`,
    },
  ];
}
